...
$startMenuShortcut = Join-Path $shortcutRoot "XENEON Edge.lnk"
$safeModeShortcut = Join-Path $shortcutRoot "XENEON Edge Recovery (Safe Mode).lnk"
$repairShortcut = Join-Path $shortcutRoot "Repair XENEON Edge.lnk"
$uninstallShortcut = Join-Path $shortcutRoot "Uninstall XENEON Edge.lnk"
$cleanupUninstallShortcut = Join-Path $shortcutRoot "Remove XENEON Edge and Local Data.lnk"
