...
assert(
  /NeedsAdmin/.test(gamePerformanceService)
    ...
    && /_elevationDeclined/.test(gamePerformanceService)
    && /ClearElevationDeclinedCore/.test(gamePerformanceService)
    && /_captureUsesElevatedBootstrap\s*&&\s*!_elevationDeclined/.test(gamePerformanceService)
    ...
    && /ClearElevationDeclined\(\)/.test(actionController)
