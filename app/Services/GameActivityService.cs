...
public sealed class GameActivityService
{
    ...
    private static bool IsKnownGamePathMatch(LauncherEntryPayload launcher, RunningProcessInfo process)
    {
        return TryInferKnownGamePath(process.ExecutablePath, out _)
